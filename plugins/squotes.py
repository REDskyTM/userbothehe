...
class Main:
    ...
    ver = 'v1.1.2'
    des = f'Цитаты от разработчиков щитнета (https://t.me/sh1tchannel/370): Fl1yd и Spy. Перекодил модуль под работу с пайрограмом: @pelmeshke'
# ты шо тут делаешь, пидор
...
@Client.on_message(filters.me & filters.command('sq', '.'))
